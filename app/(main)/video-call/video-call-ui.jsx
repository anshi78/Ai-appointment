    ...
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        ...
        <Button
          ...
          className="bg-sky-600 hover:bg-emerald-700"
        >
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border border-sky-900/20 rounded-lg overflow-hidden">
                <div className="bg-sky-900/10 px-3 py-2 text-emerald-400 text-sm font-medium">
                  You
                </div>
                <div
                  id="publisher"
              ...
              <div className="border border-sky-900/20 rounded-lg overflow-hidden">
                <div className="bg-sky-900/10 px-3 py-2 text-sky-400 text-sm font-medium">
                  Other Participant
                </div>
                <div
                  id="subscriber"
